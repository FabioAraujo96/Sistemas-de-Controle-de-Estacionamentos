// Estrutura para Cadastro de Clientes convênio
...
// Estrura para lista dinamica--> referente aos clientes cadastrados
...
//Estrura para conta de cliente convênio e avulso
...
//Estrutura para contato do cliente convênio-->PAGAMENTO!
